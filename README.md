<img width="1536" height="1024" alt="The Complete MultiModel RAG Application End to End Pipeline Banner" src="https://github.com/user-attachments/assets/13f0fe60-2cdd-4bcb-9486-a19face30497" />                # Sehaat-Saathi-Website 
...
```mermaid
graph TD;
    A[RAG Course] --> B0[Day 0: Intro RAG]
    A --> B1[Core Pipeline]
    B1 --> B1a[Day 1: Fundamentals]
    B1 --> B1b[Day 2: LLaMA Pipeline]

    A --> B2[LangChain & LlamaIndex]
    B2 --> B2a[Day 3: LC + OpenAI + FAISS]
    B2 --> B2b[Day 4: LC + Mistral + Weaviate]
    B2 --> B2c[Day 5: LlamaIndex + Mistral]
    B2 --> B2d[Day 6: LlamaIndex + Gemini]

    A --> B3[Haystack]
    B3 --> B3a[Day 7: Haystack + OpenAI]
    B3 --> B3b[Day 8: Haystack + Pinecone + Mistral]

    A --> B4[Vector DBs]
    B4 --> B4a[Day 9: MongoDB + Gemma]
    B4 --> B4b[Day 10: Mongo + Pinecone]
    B4 --> B4c[Day 11: AstraDB + LangChain]

    A --> B5[Day 12: End-to-End RAG Llama2.1]

    A --> B6[Conversational RAG]
    B6 --> B6a[Day 13: RAG + Memory]
    B6 --> B6b[Day 14: Chatbot with Memory]

    A --> B7[Day 15: LCEL Advanced]

    A --> B8[Memory Classes]
    B8 --> B8a[Day 16: Buffer Memory]
    B8 --> B8b[Day 17: Entity Memory]
    B8 --> B8c[Day 18: Summary Memory]
```
